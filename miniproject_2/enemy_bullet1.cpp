...
enemy_bullet1::enemy_bullet1(Engine::Point position, Engine::Point forwardDirection, float rotation, Enemy* parent) :
    E_Bullet("play/bullet-7.png", 500, 1,position, forwardDirection, rotation - ALLEGRO_PI / 2, parent) {
    // TODO 2 (1/8): You can imitate the 2 files: 'FireBullet.hpp', 'FireBullet.cpp' to create a new bullet.
}
void enemy_bullet1::OnExplode(Turret* turret) {
