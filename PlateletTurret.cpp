...
PlateletTurret::PlateletTurret(float x, float y) :
	Turret("play/turret-2.png", x, y, Price, 0.5,100) {
...
void PlateletTurret::CreateBullet() {
    ...
    getPlayScene()->EffectGroup->AddNewObject(new shootEffect((Position+ normalized * 36 - normal * 6) .x,(Position+ normalized * 36 - normal * 6).y));
