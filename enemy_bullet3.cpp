...
enemy_bullet3::enemy_bullet3(Engine::Point position, Engine::Point forwardDirection, float rotation, Enemy* parent) :
    E_Bullet("play/bullet-9.png", 500, 1,position, forwardDirection, rotation - ALLEGRO_PI / 2, parent) {
    // TODO 2 (1/8): You can imitate the 2 files: 'FireBullet.hpp', 'FireBullet.cpp' to create a new bullet.
}
void enemy_bullet3::OnExplode(Turret* turret) {
